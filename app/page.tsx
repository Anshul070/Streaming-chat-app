  ...
  return (
    <>
      ...
      <div className="flex h-screen overflow-hidden" style={{ backgroundColor: THEME.bg, color: THEME.text }}>
        ...
        {/* ══ SIDEBAR ═══════════════════════════════════════════════════════════
            Mobile : fixed drawer, slides in from left (z-50 over chat)
            Desktop: static column, always visible (md:translate-x-0 overrides)
        ══════════════════════════════════════════════════════════════════════ */}
        <aside
          className={`
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-5 py-5 space-y-6">
            ...
            {/* Spacer so last item isn't flush on mobile */}
            <div className="h-6" />
          </div>
        </aside>
          ...
          <div className="flex-1 overflow-y-auto px-3 sm:px-5 py-4 space-y-3">
            ...
            {messages.map(message => (
              <div key={message.id} className={`flex ${message.role === "user" ? "justify-end" : "justify-start"}`}>
                <div
                  className="max-w-[88%] sm:max-w-[80%] px-4 py-2.5 text-sm leading-relaxed"
